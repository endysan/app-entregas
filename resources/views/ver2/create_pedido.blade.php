...
<div class="container-pedido">
    ...
    <form method="POST" action="pedido">
        ...
        <div class="bloco1">
            <p class="text-muted">Informações do seu produto</p>
            <input type="hidden" name="id_usuario" value="{{ auth()->user()->id }}">

            <div class="form-group">
                <label for="produto" class="form-label">Seu produto</label>
                <input id="produto" name="produto" class="form-control" type="text" required>
            </div>
        ...
        <div class="bloco2">
            <hr/>
            <p class="text-muted">Informações de entrega</p>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input id="dt_entrega" name="dt_entrega" class="form-control" type="text"
